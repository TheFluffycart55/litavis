...
public class SusRedSandRenderer implements BlockEntityRenderer<LitavisBrushableBlockEntity>
{
    public final ItemRenderer itemRenderer;

    public SusRedSandRenderer(BlockEntityRendererFactory.Context context)
    {
        this.itemRenderer = context.getItemRenderer();
    }

    public void render(LitavisBrushableBlockEntity susBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j)
    {
